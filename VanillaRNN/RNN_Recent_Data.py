...
config = {
        ...
        "num_epochs": 200,
        "learning_rate": 0.001,
        "experiment_name": "Trained_RNN_On_Recent_Data"
    }
...
os.makedirs("images/Trained_RNN_On_Recent_Data", exist_ok=True)
csv_file = "experiment_results/RNN/Trained_RNN_On_Recent_Data.csv"
