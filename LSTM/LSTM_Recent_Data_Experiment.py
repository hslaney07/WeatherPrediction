...
config = {
        ...
        "num_epochs": 200,
        "learning_rate": 0.001, 
        "experiment_name": "Trained_LSTM_on_recent_weather"
    }
...
os.makedirs("images/Trained_LSTM_on_recent_weather", exist_ok=True)

csv_file = "experiment_results/LSTM/Trained_LSTM_on_recent_weather.csv"
