...
all_configs = [
    {
        ...
        "learning_rate": lr,
        "experiment_name": "LSTM_initial_experiment"
    }
...
os.makedirs("images/LSTM_initial_experiment", exist_ok=True)

csv_file = "experiment_results/LSTM/LSTM_initial_experiment.csv"
